...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2000-A", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "/cuiuffi2000a")
public class CUIUFFI2000AAggiornaDateCensimento extends BaseController
{
  ...
  public String modifica(@PathVariable("idConcessione") long idConcessione, Model model, HttpServletRequest request) throws InternalUnexpectedException
  {
    ...
    return "pianoselettivocinghiali/approva";
  }
