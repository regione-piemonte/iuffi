...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2007-E", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "cuiuffi2007e")
public class CUIUFFI2007EElencoDistretti extends BaseController
{
  public static final long idSpecie= 3;
  public static final String CU_NAME = "CU-IUFFI-2007-E";
  @Autowired
  ...
  public String index(Model model, HttpSession session) throws InternalUnexpectedException {
    ...
    return "pianoselettivocervi/elencodistretti";
  }
