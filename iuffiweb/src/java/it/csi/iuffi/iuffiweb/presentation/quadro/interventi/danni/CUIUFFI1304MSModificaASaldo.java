...
@Controller
@IuffiSecurity(value = "CU-IUFFI-1304-MS", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cuiuffi1304ms")
public class CUIUFFI1304MSModificaASaldo extends BaseController
{
  @Autowired
