...
public class CUIUFFI211RendicontazioneSpeseSaldoAbstract extends BaseController
{
  @Autowired
  protected IRendicontazioneEAccertamentoSpeseEJB rendicontazioneEAccertamentoSpeseEJB;
  public static final String                      JSP_BASE_URL = "interventi/rendicontazionespese/saldo/finale/";
  public static final String                      CU_BASE_NAME = "cuiuffi211";
