...
@Controller
@IuffiSecurity(value = "CU-IUFFI-303-L", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping("/cuiuffi303l")
public class CUIUFFI303LVisualizzaFabbricatiController extends BaseController
{
	@Autowired
