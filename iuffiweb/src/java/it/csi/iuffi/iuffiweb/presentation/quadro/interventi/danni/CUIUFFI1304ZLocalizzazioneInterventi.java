...
@Controller
@IuffiSecurity(value = "CU-IUFFI-1304-Z", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cuiuffi1304z")
public class CUIUFFI1304ZLocalizzazioneInterventi extends Localizza
{
  @Override
