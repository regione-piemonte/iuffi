...
@Controller
@IuffiSecurity(value = "CU-IUFFI-213-D", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cuiuffi213d")
public class CUIUFFI213DControlloinlocoMisureInvestimentoDettaglio
