...
public class DanniFaunaExcelBuilder extends AbstractExcelView
{
      ...
      throws Exception
  {
    ...
    ArrayList<DannoFaunaDTO> arrayList = (ArrayList<DannoFaunaDTO>) model.get("elenco");
    List<DannoFaunaDTO> elenco = arrayList;

    // create a new Excel sheet
    HSSFSheet sheet = workbook.createSheet("Danni Fauna");
