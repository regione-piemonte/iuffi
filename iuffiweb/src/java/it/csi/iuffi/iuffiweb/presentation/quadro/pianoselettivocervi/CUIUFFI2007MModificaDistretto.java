package it.csi.iuffi.iuffiweb.presentation.quadro.pianoselettivocervi;
...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2007-M", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "cuiuffi2007m")
public class CUIUFFI2007MModificaDistretto extends BaseController {

  public static final String CU_NAME = "CU-IUFFI-2007-M";
  public static final long idSpecie= 3;
  ...
  public String index(@PathVariable("tipo") String tipo, @PathVariable("idDistretto") long idDistretto, @PathVariable("idPianoDistrettoOgur") long idPianoDistrettoOgur, Model model, HttpServletRequest request, HttpSession session) throws InternalUnexpectedException {
    ...
    return "pianoselettivocervi/modificadistretto";
  }
  ...
  public String confermaModifica(Model model, HttpSession session, HttpServletRequest request) throws InternalUnexpectedException { 
    ...
    int censito5 = (IuffiUtils.STRING.trim(request.getParameter("censito5")) != null && !IuffiUtils.STRING.trim(request.getParameter("censito5")).equalsIgnoreCase("") ? Integer.parseInt(IuffiUtils.STRING.trim(request.getParameter("censito5"))) : 0);
    ...
    int prelievo5 = (IuffiUtils.STRING.trim(request.getParameter("prelievo5")) != null && !IuffiUtils.STRING.trim(request.getParameter("prelievo5")).equalsIgnoreCase("") ? Integer.parseInt(IuffiUtils.STRING.trim(request.getParameter("prelievo5"))) : 0);
    int prelievo6 = prelievo2+prelievo3+prelievo4;
    ...
    BigDecimal percentuale5 = null;
    BigDecimal percentuale6 = null;
    if(censito1 != 0) {
      percentuale1 = (new BigDecimal(prelievo1).divide(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP), 2, RoundingMode.HALF_UP));
    }
    else {
      percentuale1 = new BigDecimal("0");
    }
    if(censito2 != 0) {
      percentuale2 = (new BigDecimal(prelievo2).divide(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP), 2, RoundingMode.HALF_UP));
    }
    else {
      percentuale2 = new BigDecimal("0");
    }
    if(censito3 != 0) {
      percentuale3 = (new BigDecimal(prelievo3).divide(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP), 2, RoundingMode.HALF_UP));
    }
    else {
      percentuale3 = new BigDecimal("0");
    }
    if(censito4 != 0) {
      percentuale4 = (new BigDecimal(prelievo4).divide(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP), 2, RoundingMode.HALF_UP));
    }
    else {
      percentuale4 = new BigDecimal("0");
    }   
    if(censito5 != 0) {
      percentuale5 = (new BigDecimal(prelievo5).divide(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP), 2, RoundingMode.HALF_UP));
    }
    else {
      percentuale5 = new BigDecimal("0");
    }   
    if(prelievo6 != 0) {
      percentuale6 = (new BigDecimal(prelievo6).divide(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP), 2, RoundingMode.HALF_UP));
    }
    else {
      percentuale6 = new BigDecimal("0");
    }
    ...
    BigDecimal da5 = new BigDecimal(IuffiUtils.STRING.trim(request.getParameter("da5")));
    ...
    BigDecimal a5 = new BigDecimal(IuffiUtils.STRING.trim(request.getParameter("a5")));
    String esito1 = "";
    String esito2 = "";
    String esito3 = "";
    String esito4 = "";
    ...
    if(new BigDecimal(prelievo1).compareTo(a1.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) > 0 || new BigDecimal(prelievo1).compareTo(da1.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) < 0) {
      esito1 = "N";
    }
    else {
      esito1 = "S";
    }
    if(new BigDecimal(prelievo2).compareTo(a2.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) > 0 || new BigDecimal(prelievo2).compareTo(da2.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) < 0) {
      esito2 = "N";
    }
    else {
      esito2 = "S";
    }
    if(new BigDecimal(prelievo3).compareTo(a3.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) > 0 || new BigDecimal(prelievo3).compareTo(da3.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+indeterminatiP))) < 0) {
      esito3 = "N";
    }
    else {
      esito3 = "S";
    }
    if(new BigDecimal(prelievo4).compareTo(a4.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) > 0 || new BigDecimal(prelievo4).compareTo(da4.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) < 0) {
      esito4 = "N";
    }
    else {
      esito4 = "S";
    }
    if(new BigDecimal(prelievo5).compareTo(a5.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) > 0 || new BigDecimal(prelievo5).compareTo(da5.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) < 0) {
      esito5 = "N";
    }
    else {
      esito5 = "S";
    }
    if(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP <= max) {
      esitoTot = "S";
    }
    else {
      esitoTot = "N";
    ...
    for (Object o : Collections.list(iere)) {
      ...
      if (!errors.isEmpty()) {
        ...
        nuovo.setCensito5(String.valueOf(censito5));
        ...
        quadroIuffiEJB.updatePianoDistrettoOgur(new Long(idPiano), censito1+censito2+censito3+censito4+censito5+indetC, indetC, 
            prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP, indeterminatiP, 
            new BigDecimal(censito2+censito3+censito4+censito5+indetC).multiply(new BigDecimal(percMax).divide(new BigDecimal(100))), esitoTot, indeterminatiP);
        ...
        quadroIuffiEJB.insertCensitoPrelievoOgur(new Long(idPiano), idSpecie, 5, censito5, prelievo5, percentuale5, esito5, getLogOperationOggettoQuadroDTO(session));
        quadroIuffiEJB.insertCensitoPrelievoOgur(new Long(idPiano), idSpecie, 6, 0, prelievo6, percentuale6, "S", getLogOperationOggettoQuadroDTO(session));
        
        return "redirect:../cuiuffi2007v/index_"+idDistretto+"_"+tipo+"_"+idPiano+".do";
      }
    }
    ...
    @RequestMapping(value = "/esito_{prelievo}_{c1}_{c2}_{c3}_{c4}_{c5}_{indp}_{arg1}", method = RequestMethod.GET, produces = "application/text")
    @ResponseBody
    public String esito(Model model,
        ...
        @PathVariable("c4") String c4, @PathVariable("c4") String c5, @PathVariable("indp") String indp, @PathVariable("arg1") String arg1,
      ...
      if(da != null && a != null ) {
        ...
        if(!c5.equalsIgnoreCase("nan")) {
          prelievo5 = new BigDecimal(c5) ;
        }
        else {
          prelievo5 = new BigDecimal(0) ;
        }
        ...
        if(prel.compareTo(a.multiply(prelievo1.add(prelievo2.add(prelievo3.add(prelievo4.add(prelievo5.add(indet))))))) > 0 || prel.compareTo(da.multiply(prelievo1.add(prelievo2.add(prelievo3.add(prelievo4.add(prelievo5.add(indet))))))) < 0) {
          esito = "ko";
        }
        else {
          esito = "ok";
