...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2005-V", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "cuiuffi2005v")
public class CUIUFFI2005VVisualizzaDistretto extends BaseController
{

  public static final String CU_NAME = "CU-IUFFI-2005-V";
  ...
  public String index(@PathVariable("tipo") String tipo, @PathVariable("idDistretto") long idDistretto, @PathVariable("idPianoDistrettoOgur") long idPianoDistrettoOgur, Model model, HttpServletRequest request, HttpSession session) throws InternalUnexpectedException {
    ...
    return "pianoselettivomufloni/dettagliodistretto";
  }
