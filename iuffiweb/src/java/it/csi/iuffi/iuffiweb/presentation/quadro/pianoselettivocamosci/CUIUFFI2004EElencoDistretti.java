...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2004-E", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "cuiuffi2004e")
public class CUIUFFI2004EElencoDistretti extends BaseController
{
  public static final long idSpecie= 1;
  public static final String CU_NAME = "CU-IUFFI-2004-E";
  @Autowired
  ...
  public String index(Model model, HttpSession session) throws InternalUnexpectedException {
    ...
    return "pianoselettivocamosci/elencodistretti";
  }
