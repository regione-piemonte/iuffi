...
@Controller
@IuffiSecurity(value = "CU-IUFFI-192-V", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cuiuffi192v")
public class CUIUFFI192VVisualizzaDocumentiSpesaRendicontazione
    extends CUIUFFI192RendicontazioneSpeseAbstract
{
      ...
      throws InternalUnexpectedException
  {
    ...
    Map<String, Object> common = getCommonFromSession("CU-IUFFI-192", session,
        true);
