...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2008-E", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "cuiuffi2008e")
public class CUIUFFI2008EElencoDistretti extends BaseController
{
  public static final long idSpecie= 4;
  public static final String CU_NAME = "CU-IUFFI-2008-E";
  @Autowired
  ...
  public String index(Model model, HttpSession session) throws InternalUnexpectedException {
    ...
    return "pianoselettivodaini/elencodistretti";
  }
