...
@Controller
@IuffiSecurity(value = "CU-IUFFI-271", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
public class CUIUFFI271GeneraStampaLetteraIntegPagamento
    extends StampaController
{
  @RequestMapping(value = "/cuiuffi271/stampa")
  public ResponseEntity<byte[]> stampa(HttpSession session) throws Exception
  {
    return stampaByCUName(getIdProcedimentoOggetto(session),
        CUIUFFI271GeneraStampaLetteraIntegPagamento.class
