...
@Controller
@IuffiSecurity(value = "CU-IUFFI-303-D", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping("/cuiuffi303d")
public class CUIUFFI303DDettaglioFabbricatiController extends BaseController
{
	  @Autowired
