...
@Controller
@IuffiSecurity(value = "CU-IUFFI-133-M", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cuiuffi133m")
public class CUIUFFI133MModificaInterventi extends Modifica
{
  @Override
