package it.csi.iuffi.iuffiweb.presentation.quadro.pianoselettivodaini;
...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2008-M", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "cuiuffi2008m")
public class CUIUFFI2008MModificaDistretto extends BaseController {

  public static final String CU_NAME = "CU-IUFFI-2008-M";
  public static final long idSpecie= 4;
  ...
  public String index(@PathVariable("tipo") String tipo, @PathVariable("idDistretto") long idDistretto, @PathVariable("idPianoDistrettoOgur") long idPianoDistrettoOgur, Model model, HttpServletRequest request, HttpSession session) throws InternalUnexpectedException {
    ...
    return "pianoselettivodaini/modificadistretto";
  }
  ...
  public String confermaModifica(Model model, HttpSession session, HttpServletRequest request) throws InternalUnexpectedException { 
    ...
    if(new BigDecimal(prelievo3).compareTo(a3.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) > 0 || new BigDecimal(prelievo3).compareTo(da3.multiply(new BigDecimal(prelievo1+prelievo2+prelievo3+prelievo4+prelievo5+indeterminatiP))) < 0) {
      esito3 = "N";
    }
    else {
      esito3 = "S";
    ...
    for (Object o : Collections.list(iere)) {
      ...
      if (!errors.isEmpty()) {
        ...
        return "redirect:../cuiuffi2008v/index_"+idDistretto+"_"+tipo+"_"+idPiano+".do";
      }
    }
