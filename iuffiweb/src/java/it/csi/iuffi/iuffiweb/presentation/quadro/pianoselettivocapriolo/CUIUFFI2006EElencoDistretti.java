...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2006-E", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "cuiuffi2006e")
public class CUIUFFI2006EElencoDistretti extends BaseController
{
  public static final long idSpecie= 2;
  public static final String CU_NAME = "CU-IUFFI-2006-E";
  @Autowired
  ...
  public String index(Model model, HttpSession session) throws InternalUnexpectedException {
    ...
    return "pianoselettivocaprioli/elencodistretti";
  }
