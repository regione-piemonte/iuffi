...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2006-V", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "cuiuffi2006v")
public class CUIUFFI2006VVisualizzaDistretto extends BaseController
{

  public static final String CU_NAME = "CU-IUFFI-2006-V";
  ...
  public String index(@PathVariable("tipo") String tipo, @PathVariable("idDistretto") long idDistretto, @PathVariable("idPianoDistrettoOgur") long idPianoDistrettoOgur, Model model, HttpServletRequest request, HttpSession session) throws InternalUnexpectedException {
    ...
    return "pianoselettivocaprioli/dettagliodistretto";
  }
