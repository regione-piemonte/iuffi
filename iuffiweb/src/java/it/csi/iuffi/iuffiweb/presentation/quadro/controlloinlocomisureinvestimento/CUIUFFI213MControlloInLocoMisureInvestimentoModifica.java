package it.csi.iuffi.iuffiweb.presentation.quadro.controlloinlocomisureinvestimento;
...
@Controller
@IuffiSecurity(value = "CU-IUFFI-213-M", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cuiuffi213m")
public class CUIUFFI213MControlloInLocoMisureInvestimentoModifica
    extends BaseController
{
      ...
      DatiSpecificiDTO datiSpecifici) throws InternalUnexpectedException
  {
    ...
    model.addAttribute("modalitaSelezione",
        CUIUFFI213DControlloinlocoMisureInvestimentoDettaglio
      ...
      throws InternalUnexpectedException
  {
    ...
    {
      // Inserimento
      return "redirect:../cuiuffi213d/index.do";
    }
    else
    {
      model.addAttribute("preferRequest", Boolean.TRUE);
