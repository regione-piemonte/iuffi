...
@Controller
@IuffiSecurity(value = "CU-IUFFI-212-V", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cuiuffi212v")
public class CUIUFFI212VAccertamentoMedianteDocumentiSpesa
    extends CUIUFFI212AccertamentoSpeseSaldoAbstract
{
      ...
      throws InternalUnexpectedException
  {
    ...
    Map<String, Object> common = getCommonFromSession("CU-IUFFI-212-V", session,
        true);
