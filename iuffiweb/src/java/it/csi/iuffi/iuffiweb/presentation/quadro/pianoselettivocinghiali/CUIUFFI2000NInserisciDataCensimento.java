...
@Controller
@IuffiSecurity(value = "CU-IUFFI-2000-N", controllo = IuffiSecurity.Controllo.NESSUNO)
@RequestMapping(value = "/cuiuffi2000n")
public class CUIUFFI2000NInserisciDataCensimento extends BaseController
{
  ...
  public String index(@PathVariable("idConcessione") long idConcessione, Model model, HttpServletRequest request) throws InternalUnexpectedException
  {
    ...
    return "pianoselettivocinghiali/confermaChiusura";
  }
