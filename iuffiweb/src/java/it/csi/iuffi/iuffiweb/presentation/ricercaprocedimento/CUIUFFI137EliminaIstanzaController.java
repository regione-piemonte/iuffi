...
@Controller
@RequestMapping("/cuiuffi137")
@IuffiSecurity(value = "CU-IUFFI-137", controllo = IuffiSecurity.Controllo.PROCEDIMENTO)
public class CUIUFFI137EliminaIstanzaController extends BaseController
{
      ...
      throws InternalUnexpectedException
  {
    setModelDialogWarning(model,
        ...
        "../cuiuffi137/popupindex_" + paginaPadre + "_" + idProcedimento + "_"
