...
@Controller
@IuffiSecurity(value = "CU-IUFFI-211-R", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cuiuffi211r")
public class CUIUFFI211RRendicontazioneMedianteDocumentiSpesa
    extends CUIUFFI211RendicontazioneSpeseSaldoAbstract
{
      ...
      throws InternalUnexpectedException, ApplicationException
  {
    ...
    Map<String, Object> common = getCommonFromSession("CU-IUFFI-211-R", session,
        true);
