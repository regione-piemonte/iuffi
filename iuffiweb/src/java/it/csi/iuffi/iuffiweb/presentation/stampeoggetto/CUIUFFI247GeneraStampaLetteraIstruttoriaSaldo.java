...
@Controller
@IuffiSecurity(value = "CU-IUFFI-247", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO)
public class CUIUFFI247GeneraStampaLetteraIstruttoriaSaldo
    extends StampaController
{
  @RequestMapping(value = "/cuiuffi247/stampa")
  public ResponseEntity<byte[]> stampa(HttpSession session) throws Exception
  {
    return stampaByCUName(getIdProcedimentoOggetto(session),
        CUIUFFI247GeneraStampaLetteraIstruttoriaSaldo.class
