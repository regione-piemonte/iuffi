package it.csi.iuffi.iuffiweb.presentation.riapertura;
...
@Controller
@IuffiSecurity(value = "CU-IUFFI-170", controllo = IuffiSecurity.Controllo.PROCEDIMENTO_OGGETTO_CHIUSO)
@RequestMapping("/cuiuffi170")
public class CUIUFFI170RiaperturaOggettoNonIstanza extends BaseController
{
      ...
      throws InternalUnexpectedException
  {
    ...
    if (msgErrore == null)
    {
      model.addAttribute("url", "../cuiuffi170/riepilogo.do");
  ...
  @IuffiSecurity(value = "CU-IUFFI-170", controllo = IuffiSecurity.Controllo.NESSUNO)
