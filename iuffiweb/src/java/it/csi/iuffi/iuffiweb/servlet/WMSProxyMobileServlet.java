...
/**
 * Servlet implementation class WMSProxyMobileServlet
 */
@WebServlet(name = "WMSProxyMobileServlet", value = "/rest/proxywms", loadOnStartup = 1)
public class WMSProxyMobileServlet extends HttpServlet
{
  /** serialVersionUID */
  private static final long       serialVersionUID = -3807047194850080260L;
  private static final String     THIS_CLASS       = "WMSProxyMobileServlet";
