...
public class VerbalePreavvisoRevocaPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbalePreavvisoRevocaPositivo()
  {
    super();
  }

  public VerbalePreavvisoRevocaPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_VerbPreavvisoRevoca";
  }
