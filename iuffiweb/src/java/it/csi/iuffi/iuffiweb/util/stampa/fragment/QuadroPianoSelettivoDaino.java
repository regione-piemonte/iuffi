...
public class QuadroPianoSelettivoDaino extends Fragment {
    ...
    if((distretti!=null && distretti.size() > 0) || (distrettiRegione!=null && distrettiRegione.size() > 0)) {
      ...
      if(distrettiList != null) {      
        for (Distretto distrettoCompleto : distrettiList) {
          ...
          writeTag(writer, "Etich2", "Percentuale");
          writeTag(writer, "Conten2", distrettoCompleto.getPerc4() != null ? distrettoCompleto.getPerc4().toString() : "0.00");
          writeTag(writer, "Etich3", "Controllo");
          ...
          writeTag(writer, "Etich2", "Percentuale");
          writeTag(writer, "Conten2", distrettoCompleto.getPerc5() != null ? distrettoCompleto.getPerc5().toString() : "0.00");
          writeTag(writer, "Etich3", "Controllo");
