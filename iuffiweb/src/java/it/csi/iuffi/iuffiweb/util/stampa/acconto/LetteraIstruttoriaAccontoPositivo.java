...
public class LetteraIstruttoriaAccontoPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public LetteraIstruttoriaAccontoPositivo()
  {
    super();
  }

  public LetteraIstruttoriaAccontoPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_comunicazioneAcconto-P";
  }
  ...
  {
    return BASE_RIF_ADOBE + "comunicazioneAcconto-P.xdp";
  }
