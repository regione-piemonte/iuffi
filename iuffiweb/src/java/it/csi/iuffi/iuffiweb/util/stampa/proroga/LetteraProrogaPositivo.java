...
public class LetteraProrogaPositivo extends Stampa
{
  ...
  public LetteraProrogaPositivo()
  {
    super();
  }

  public LetteraProrogaPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_LetteraProrogaPositivo";
  }
  ...
  {
    return BASE_RIF_ADOBE + "LetteraProrogaPositivo.xdp";
  }
  ...
  public String getDefaultFileName(long idProcedimentoOggetto) throws InternalUnexpectedException, NamingException
  {
    ...
    return ret + "_comunicazioneProroga.pdf";
  }
}
