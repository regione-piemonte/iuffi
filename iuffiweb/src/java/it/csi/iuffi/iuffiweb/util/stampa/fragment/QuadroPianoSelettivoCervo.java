...
public class QuadroPianoSelettivoCervo extends Fragment {
    ...
    if((distretti!=null && distretti.size() > 0) || (distrettiRegione!=null && distrettiRegione.size() > 0)) {
      ...
      if(distrettiList != null) {      
        for (Distretto distrettoCompleto : distrettiList) {
          ...
          writer.writeStartElement("RigaCensimenti");
          writeTag(writer, "Etichetta", distrettoCompleto.getEt4());
          writeTag(writer, "Contenuto", distrettoCompleto.getCensito4());
          writer.writeEndElement(); //RigaCensimenti
          
          writer.writeStartElement("RigaCensimenti");
          writeTag(writer, "Etichetta", distrettoCompleto.getEt5());
          writeTag(writer, "Contenuto", distrettoCompleto.getCensito5());
          writer.writeEndElement(); //RigaCensimenti
          ...
          writeTag(writer, "Etich2", "Percentuale");
          writeTag(writer, "Conten2", distrettoCompleto.getPerc3() != null ? distrettoCompleto.getPerc3().toString().toString() : "0.00");
          writeTag(writer, "Etich3", "Controllo");
          ...
          writer.writeStartElement("RigaControlliPiano");
          writeTag(writer, "Etich1", distrettoCompleto.getEt4());
          writeTag(writer, "Conten1", distrettoCompleto.getPrelievo4());
          writeTag(writer, "Etich2", "Percentuale");
          writeTag(writer, "Conten2", distrettoCompleto.getPerc4() != null ? distrettoCompleto.getPerc4().toString().toString() : "0.00");
          writeTag(writer, "Etich3", "Controllo");
          if(distrettoCompleto.getEsito4() == null || distrettoCompleto.getEsito4().equalsIgnoreCase("")) {
            writeTag(writer, "Conten3", "");
          }
          else {
            writeTag(writer, "Conten3", distrettoCompleto.getEsito4().equalsIgnoreCase("S") ? "ok" : "ko");
          }      
          writer.writeEndElement(); //RigaControlliPiano
          
          writer.writeStartElement("RigaControlliPiano");
          writeTag(writer, "Etich1", distrettoCompleto.getEt5());
          writeTag(writer, "Conten1", distrettoCompleto.getPrelievo5());
          writeTag(writer, "Etich2", "Percentuale");
          writeTag(writer, "Conten2", distrettoCompleto.getPerc5() != null ? distrettoCompleto.getPerc5().toString().toString() : "0.00");
          writeTag(writer, "Etich3", "Controllo");
          if(distrettoCompleto.getEsito5() == null || distrettoCompleto.getEsito5().equalsIgnoreCase("")) {
            writeTag(writer, "Conten3", "");
          }
          else {
            writeTag(writer, "Conten3", distrettoCompleto.getEsito5().equalsIgnoreCase("S") ? "ok" : "ko");
          }      
          writer.writeEndElement(); //RigaControlliPiano
          
          writer.writeStartElement("RigaControlliPiano");
          writeTag(writer, "Etich1", distrettoCompleto.getEt6());
          writeTag(writer, "Conten1", distrettoCompleto.getPrelievo6());
          writeTag(writer, "Etich2", "Percentuale");
          if(distrettoCompleto.getPerc6() != null) {
            writeTag(writer, "Conten2", distrettoCompleto.getPerc6().toString());
          }
          else {
            writeTag(writer, "Conten2", "0.00");
          }
          writeTag(writer, "Etich3", "Controllo");
          if(distrettoCompleto.getEsito6() == null || distrettoCompleto.getEsito6().equalsIgnoreCase("")) {
            writeTag(writer, "Conten3", "");
          }
          else {
            writeTag(writer, "Conten3", distrettoCompleto.getEsito6().equalsIgnoreCase("S") ? "ok" : "ko");
          }      
          writer.writeEndElement(); //RigaControlliPiano
