...
public class LetteraIntegPagamento extends Stampa
{
  ...
  public LetteraIntegPagamento()
  {
    super();
  }

  public LetteraIntegPagamento(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_ComunicazioneIntegPagamento";
  }
  ...
  {
    return BASE_RIF_ADOBE + "ComunicazioneIntegPagamento.xdp";
  }
      ...
      throws InternalUnexpectedException, NamingException
  {
    ...
    return ret + "_ComunicazioneIntegPagamento.pdf";
  }
}
