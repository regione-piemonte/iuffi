...
public class VerbaleIstruttoriaAnticipoPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbaleIstruttoriaAnticipoPositivo()
  {
    super();
  }

  public VerbaleIstruttoriaAnticipoPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_verbaleIstruttoriaAnticipo-P";
  }
  ...
  {
    return BASE_RIF_ADOBE + "verbaleIstruttoriaAnticipo-P.xdp";
  }
