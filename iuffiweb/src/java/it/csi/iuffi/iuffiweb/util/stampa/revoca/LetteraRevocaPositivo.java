...
public class LetteraRevocaPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";
  private String             cuNameRef = null;

  public LetteraRevocaPositivo()
  {
    super();
  }

  public LetteraRevocaPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return BASE_RIF_ADOBE + "LetteraRevoca.xdp";
  }

  @Override
    public String getDefaultFileName(long idProcedimentoOggetto)
  {
    return "ComunicazioneRevocaPositivo.pdf";
  }
}
