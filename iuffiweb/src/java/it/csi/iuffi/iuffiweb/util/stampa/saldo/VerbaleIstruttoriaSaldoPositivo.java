...
public class VerbaleIstruttoriaSaldoPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbaleIstruttoriaSaldoPositivo()
  {
    super();
  }

  public VerbaleIstruttoriaSaldoPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_verbaleIstruttoriaSaldo-P";
  }
  ...
  {
    return BASE_RIF_ADOBE + "verbaleIstruttoriaSaldo-P.xdp";
  }
