...
public class LetteraVolturaPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";
  private String             cuNameRef = null;

  public LetteraVolturaPositivo()
  {
    super();
  }

  public LetteraVolturaPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_LetteraVolturaPositivo";
  }
  ...
  {
    return BASE_RIF_ADOBE + "LetteraVolturaPositivo.xdp";
  }

  @Override
    public String getDefaultFileName(long idProcedimentoOggetto)
  {
    return "ComunicazioneVolturaPositivo.pdf";
  }
}
