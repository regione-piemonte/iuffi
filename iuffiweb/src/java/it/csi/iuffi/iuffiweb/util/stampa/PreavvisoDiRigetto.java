...
public class PreavvisoDiRigetto extends Stampa
{
  ...
  public PreavvisoDiRigetto()
  {
    super();
  }

  public PreavvisoDiRigetto(String cuNameRef)
  {
    super();
  ...
  {
    return BASE_RIF_ADOBE + "preavvisoRigetto.xdp";
  }
