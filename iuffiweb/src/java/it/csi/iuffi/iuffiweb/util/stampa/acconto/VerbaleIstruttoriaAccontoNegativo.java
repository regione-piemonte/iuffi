...
public class VerbaleIstruttoriaAccontoNegativo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";
  private String             cuNameRef = null;

  public VerbaleIstruttoriaAccontoNegativo()
  {
    super();
  }

  public VerbaleIstruttoriaAccontoNegativo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_verbaleIstruttoriaAcconto-N";
  }
  ...
  {
    return BASE_RIF_ADOBE + "verbaleIstruttoriaAcconto-N.xdp";
  }
