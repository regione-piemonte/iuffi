...
public class VerbaleRevocaNegativo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";
  private String             cuNameRef = null;

  public VerbaleRevocaNegativo()
  {
    super();
  }

  public VerbaleRevocaNegativo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_VerbaleRevocaNegativo";
  }
  ...
  {
    return BASE_RIF_ADOBE + "VerbaleRevocaNegativo.xdp";
  }

  @Override
    public String getDefaultFileName(long idProcedimentoOggetto)
  {
    return "VerbaleRevocaNegativo.pdf";
  }
}
