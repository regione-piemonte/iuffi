...
public class VerbaleVolturaPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbaleVolturaPositivo()
  {
    super();
  }

  public VerbaleVolturaPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_VerbaleVolturaPositivo";
  }
  ...
  {
    return BASE_RIF_ADOBE + "VerbaleVolturaPositivo.xdp";
  }

  @Override
    public String getDefaultFileName(long idProcedimentoOggetto)
  {
    return "VerbaleIstruttoriaVoltura.pdf";
  }
}
