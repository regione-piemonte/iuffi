...
public class LetteraIstruttoriaSaldoParziale extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public LetteraIstruttoriaSaldoParziale()
  {
    super();
  }

  public LetteraIstruttoriaSaldoParziale(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_comunicazioneSaldo-PN";
  }
  ...
  {
    return BASE_RIF_ADOBE + "comunicazioneSaldo-PN.xdp";
  }
