...
public class AmmissioneFinanziamento extends Stampa
{
      ...
      throws InternalUnexpectedException, NamingException
  {
    ...
    if (cuName
      ...
      return ret + "_Lettera ammissione istruttoria variante.pdf";
    else
      return ret + "_Lettera ammissione finanziamento.pdf";
  }
      ...
      throws Exception
  {
    ...
    boolean preavvisoRigettoPresente = quadroEJB.findOggettoByIdProcedimento(
        po.getIdProcedimento(),
        IuffiConstants.OGGETTO.CODICE.PREAVVISO_RIGETTO);
