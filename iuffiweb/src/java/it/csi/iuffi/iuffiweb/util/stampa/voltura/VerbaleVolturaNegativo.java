...
public class VerbaleVolturaNegativo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";
  private String             cuNameRef = null;

  public VerbaleVolturaNegativo()
  {
    super();
  }

  public VerbaleVolturaNegativo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_VerbaleVolturaNegativo";
  }
  ...
  {
    return BASE_RIF_ADOBE + "VerbaleVolturaNegativo.xdp";
  }
