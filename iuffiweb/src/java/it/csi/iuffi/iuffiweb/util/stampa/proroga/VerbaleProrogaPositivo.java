...
public class VerbaleProrogaPositivo extends Stampa
{
  public static final String ROOT_TAG  = "Domanda";

  private String             cuNameRef = null;

  public VerbaleProrogaPositivo()
  {
    super();
  }

  public VerbaleProrogaPositivo(String cuNameRef)
  {
    super();
  ...
  {
    return "IUF_VerbaleProrogaPositivo";
  }
  ...
  {
    return BASE_RIF_ADOBE + "VerbaleProrogaPositivo.xdp";
  }
